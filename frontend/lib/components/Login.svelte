...
<Modal bind:open size="sm" autoclose={false} class="w-full">
  <div class="text-center mb-6">
    <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">SheetPilot Login</h3>
    <p class="text-sm text-gray-500 dark:text-gray-400">Sign in to manage your timesheets</p>
  </div>
  ...
  <form on:submit|preventDefault={handleLogin} class="space-y-4">
    ...
    <div class="flex items-center">
      <Checkbox bind:checked={stayLoggedIn} disabled={isLoggingIn}>Stay logged in</Checkbox>
    </div>
  ...
  <div class="text-center mt-4">
    <p class="text-xs text-gray-500 dark:text-gray-400">Admin credentials: Admin / SWFL_ADMIN</p>
  </div>
</Modal>
