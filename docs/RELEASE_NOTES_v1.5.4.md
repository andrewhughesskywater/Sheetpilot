# Sheetpilot v1.5.4 Release Notes
**Release Date**: December 12, 2025  
**Previous Version**: v1.5.3

## 🎉 Overview
Version 1.5.4 is a patch release focused on architectural improvements, browser automation enhancements, and build system optimizations. This release improves code organization, fixes environment variable handling, and enhances the development experience.
...
Sheetpilot will automatically download and install v1.5.4 when you close the application.

**Steps**:
1. Close Sheetpilot
2. Update will install automatically
3. Launch Sheetpilot v1.5.4

### Manual Installation
1. Download Sheetpilot Setup 1.5.4 from the release page
2. Close any running instances of Sheetpilot
3. Run the installer
4. Launch Sheetpilot v1.5.4
