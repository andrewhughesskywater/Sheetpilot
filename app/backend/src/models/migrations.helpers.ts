/**
 * @fileoverview Migration Helper Functions
 *
 * Helper functions extracted from migrations to reduce complexity.
 *
...
/**
 * Checks if hours column is generated by examining CREATE TABLE statement
 */
...
/**
 * Checks if hours column is generated using PRAGMA table_info
 */
...
/**
 * Checks if hours column is generated by attempting an INSERT test
 */
...
/**
 * Checks if the hours column in the timesheet table is a generated column
...
/**
 * Creates the timesheet table with the correct schema (hours as regular column)
 */
...
/**
 * Migrates data from old timesheet table to new one
 */
...
/**
 * Replaces old timesheet table with new one and recreates indexes
 */
...
/**
 * Creates business configuration tables
 */
...
/**
 * Seeds business configuration from static config
 */
