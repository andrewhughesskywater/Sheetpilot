...
export function setIpcMainWindow(mainWindow: BrowserWindow | null, logger: LoggerLike): void {
  if (!ipcModuleLoaded) {
    logger.warn('Could not set IPC main window reference', { reason: 'IPC module not loaded' });
    return;
  }
