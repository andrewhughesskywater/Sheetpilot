/**
 * @fileoverview Business Configuration - Static Data
 *
 * Static business configuration data used throughout the application.
 * This data is used for:
 * 1. Database seeding during Migration 4
 * 2. Fallback when database is unavailable
 ...
 */
export type ProjectWithoutTools = (typeof PROJECTS_WITHOUT_TOOLS)[number];
export type ToolWithoutCharges = (typeof TOOLS_WITHOUT_CHARGES)[number];
 ...
 */
export const PROJECTS_WITHOUT_TOOLS_SET = new Set<string>(
  PROJECTS_WITHOUT_TOOLS
);
export const TOOLS_WITHOUT_CHARGES_SET = new Set<string>(TOOLS_WITHOUT_CHARGES);
export const PROJECTS_SET = new Set<string>(PROJECTS);
export const CHARGE_CODES_SET = new Set<string>(CHARGE_CODES);
