/**
 * @fileoverview Business Configuration - Window Interface Declarations
 *
 * Type declarations for window.businessConfig used in browser/renderer context.
 * This provides the TypeScript contract for IPC communication between frontend and backend.
 *
