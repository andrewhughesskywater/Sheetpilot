      ...
      >
        ...
        {[...Array(12)].map((_, index) => (
          <Box key={index} sx={{ display: 'flex', gap: 1, mb: 0.5 }}>
            <Skeleton variant="rectangular" width="10%" height={30} sx={{ animationDelay: `${index * 40}ms` }} />
            <Skeleton variant="rectangular" width="12%" height={30} sx={{ animationDelay: `${index * 40}ms` }} />
            <Skeleton variant="rectangular" width="12%" height={30} sx={{ animationDelay: `${index * 40}ms` }} />
            <Skeleton variant="rectangular" width="12%" height={30} sx={{ animationDelay: `${index * 40}ms` }} />
            <Skeleton variant="rectangular" width="25%" height={30} sx={{ animationDelay: `${index * 40}ms` }} />
            <Skeleton variant="rectangular" width="15%" height={30} sx={{ animationDelay: `${index * 40}ms` }} />
            <Skeleton variant="rectangular" width="14%" height={30} sx={{ animationDelay: `${index * 40}ms` }} />
          </Box>
        ))}
      </Box>
    </Box>
