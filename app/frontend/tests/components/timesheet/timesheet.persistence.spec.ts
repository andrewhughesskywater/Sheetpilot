...
import {
  ...
  batchSaveToDatabase,
  deleteDraftRows,
} from "../../../src/components/timesheet/timesheet.persistence";
...
describe("Timesheet Persistence Module", () => {
  ...
  describe("batchSaveToDatabase", () => {
    ...
    it("should skip incomplete rows", async () => {
      const data: TimesheetRow[] = [
        { date: "01/15/2025", project: "Test" }, // Missing hours, taskDescription
        {
          date: "01/16/2025",
          hours: 8.0,
          project: "Complete",
  ...
  describe("deleteDraftRows", () => {
    ...
    it("should handle deletion failures", async () => {
      mockWindow.timesheet.deleteDraft
    ...
    it("should handle API unavailable", async () => {
      (global as { window?: unknown }).window = {
        timesheet: { deleteDraft: undefined },
      };
    ...
    it("should handle exceptions during deletion", async () => {
      mockWindow.timesheet.deleteDraft.mockRejectedValue(
  ...
  describe("Error Handling", () => {
    it("should log errors during save", async () => {
      mockWindow.timesheet.saveDraft.mockRejectedValue(
