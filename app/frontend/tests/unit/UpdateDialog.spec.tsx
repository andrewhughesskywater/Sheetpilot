...
describe('UpdateDialog', () => {
  it('should render when open', () => {
    render(<UpdateDialog open={true} version="1.5.1" progress={50} status="downloading" />);

    expect(screen.getByText('Downloading Update')).toBeInTheDocument();
  });

  it('should not render when closed', () => {
    render(<UpdateDialog open={false} version="1.5.1" progress={50} status="downloading" />);
  ...
  it('should display installing status', () => {
    render(<UpdateDialog open={true} version="1.5.1" status="installing" />);
  ...
  it('should display progress when downloading', () => {
    render(<UpdateDialog open={true} version="1.5.1" progress={75.5} status="downloading" />);

    expect(screen.getByText('75.5%')).toBeInTheDocument();
  });

  it('should not display progress when installing', () => {
    render(<UpdateDialog open={true} version="1.5.1" progress={50} status="installing" />);
